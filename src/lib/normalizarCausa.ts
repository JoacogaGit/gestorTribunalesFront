...
export function normalizarCausa(c: unknown): CausaIA {
  ...
  return {
    ...
    fuero: toStringOrNull(src.fuero),
    rol_estudio: toStringOrNull(src.rol_estudio),
    damnificado: toStringOrNull(src.damnificado),
    juez: toStringOrNull(src.juez),
    fiscal: toStringOrNull(src.fiscal),
